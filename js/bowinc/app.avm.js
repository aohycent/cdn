...
$(".buy_btn").on("click", function(){
	var PDTdata = $(this).attr("avm-data");
	var PDTval = $(this).attr("avm-value");
	var PDTcat = $(this).attr("avm-category");
	var PDTdur = $(this).attr("avm-dur");
	$.ajax({
		type: "POST",
		url: "api.apl",
		data: {
