...
contract AonyexToken is Ownable, SignerRole, ERC1155Base {
    string public name;
...
contract AonyexUserToken is AonyexToken {
    event CreateERC1155_v1(address indexed creator, string name, string symbol);

    constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) AonyexToken(name, symbol, signer, contractURI, tokenURIPrefix) public {
